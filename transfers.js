...
// Event listeners
document.getElementById("toType").addEventListener("change", populateToAccounts)
...
document.getElementById("confirmTransfer").addEventListener("click", () => {
  ...
  const fromAccount = currentUser.accounts.find((a) => a.id === transfer.fromAccountId)
  const toAccount = currentUser.accounts.find((a) => a.id === transfer.toAccountId)
